...
console.log(isAdmin, page.props.auth.user.roles);
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <Dropdown align="right" heigth="full" class="my-auto">
                                    <template #trigger>
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('usuarios.create')"> Criar Motorista </DropdownLink>
                                        <DropdownLink :href="route('pagamentos.create')"> Criar Pagamento </DropdownLink>
                                    </template>
                                </Dropdown>
